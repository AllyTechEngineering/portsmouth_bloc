...
class SmallPhoneLandscapeScreen extends StatefulWidget {
  const SmallPhoneLandscapeScreen({super.key});

  @override
  State<SmallPhoneLandscapeScreen> createState() => _SmallPhoneLandscapeScreenState();
}

class _SmallPhoneLandscapeScreenState extends State<SmallPhoneLandscapeScreen> {
