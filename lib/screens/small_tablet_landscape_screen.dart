...
class SmallTabletLandscapeScreen extends StatefulWidget {
  const SmallTabletLandscapeScreen({super.key});

  @override
  State<SmallTabletLandscapeScreen> createState() => _SmallTabletLandscapeScreenState();
}

class _SmallTabletLandscapeScreenState extends State<SmallTabletLandscapeScreen> {
